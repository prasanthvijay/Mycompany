...
module.exports = class Resource extends Component {
 constructor(props) {
   ...
   screenType: '',categoryDetails:[],
	isVisible:true,types:'Circle', color: "#7EFF71", size: 50,isModalVisible: false,retry:false,resultData:false,programid:''
    };
  ...
  render() {
 	...
 	var microAppList = _this.state.categoryDetails.map((categoryDetails, index) => {
            return (
		                ...
		                <Right>
		                    <Button transparent onPress={() => _this.onPress(categoryDetails.filepath,categoryDetails.id,categoryDetails.extension) }>
...
if(_this.state.retry==true){
	...
	<Header style={{backgroundColor: '#66FF4D',}}>
                <Left>
