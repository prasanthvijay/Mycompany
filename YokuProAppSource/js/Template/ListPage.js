...
module.exports = class Resource extends Component {
 constructor(props) {
    super(props);
    this.state = {
   screenType: '',eventsDetails:[],isVisible:true,types:'Circle', color: "#6BCAE2", size: 50,isModalVisible: false,resultData:false
  ...
  render() {
	...
	if(this.state.resultData==true){
			...
			var resultData=<View style={{alignSelf:"center"}}>
				<Text style={{color: '#4B87C8' , fontWeight:'bold'}}>No Events Avaliable..!</Text>		
			</View>;			
		}
