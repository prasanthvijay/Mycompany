...
navigateTo(route) {
 ...
 <Navigator
		...
		case 'ProgramDetails':
                  return <ProgramDetails navigator={navigator} {...route.passProps}  />;
		case 'ProgramEvaluate':
                  return <ProgramEvaluate navigator={navigator} {...route.passProps}  />;
		case 'Evaluate':
                  return <ProgramEvaluate navigator={navigator} {...route.passProps}  />;
		case 'Summary':
                  return <Synopsis navigator={navigator} {...route.passProps}  />;
		case 'AskHelp':
