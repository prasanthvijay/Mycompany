...
async navigate(){
		...
		AsyncStorage.setItem("imagepath", userDetailsList['imagepath']+"");
  ...
  render() {
			...
			{	
			errorMsg=<View style={{alignSelf:'center',}}><Text style={{color:'red', fontSize: 15,}}>Please enter a user name.</Text></View>; 	
			}
			if(this.state.passwordValidation==true)
			{	
			errorMsg=<View style={{alignSelf:'center',}}><Text style={{color:'red', fontSize: 15,}}>Please enter a password.</Text></View>; 	
			}
		...
		if(this.state.retry==true){
			...
			var retry=<View style={{alignSelf:"center",flex:1,paddingTop:10}}>
					...
					<Text style={{color:"#FFFFFF"}}>You seem to be offline</Text>
					 ...
					 <Button  rounded style={{backgroundColor:'#EC9B64',height:35,alignSelf:"center"}} onPress={()=>this.onPress()}>
